...
public final class DateUtil {
     ...
     * java 8 时间格式化
     */
    private static final DateTimeFormatter DATETIME_FORMATTER = com.seven.cow.spring.boot.autoconfigure.util.DateTimeFormatter.getDateTimeFormatter(PATTERN_DATETIME);
    private static final DateTimeFormatter DATE_FORMATTER = com.seven.cow.spring.boot.autoconfigure.util.DateTimeFormatter.getDateTimeFormatter(PATTERN_DATE);
    private static final DateTimeFormatter TIME_FORMATTER = com.seven.cow.spring.boot.autoconfigure.util.DateTimeFormatter.getDateTimeFormatter(PATTERN_TIME);
