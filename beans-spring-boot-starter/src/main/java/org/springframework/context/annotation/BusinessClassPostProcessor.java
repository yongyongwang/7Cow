...
public class BusinessClassPostProcessor implements BeanDefinitionRegistryPostProcessor,
        PriorityOrdered, ResourceLoaderAware, BeanClassLoaderAware, EnvironmentAware {

    private final Logger logger = LoggerFactory.getLogger(BusinessClassPostProcessor.class);

    private static final String IMPORT_REGISTRY_BEAN_NAME =
            BusinessClassPostProcessor.class.getName() + ".importRegistry";
