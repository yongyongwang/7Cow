 ...
 * @since 3.0
 */
class BusinessConfigurationClassParser {
    ...
    private final BusinessComponentScanAnnotationParser componentScanParser;
    ...
    /**
     * Create a new {@link BusinessConfigurationClassParser} instance that will be used
